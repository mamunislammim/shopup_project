  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StickIt(
        ...
        stickerList: [
          Image.asset('imagess/p1.png'),
          Image.asset('imagess/p2.jpeg'),
          Image.asset('imagess/p4.jpg'),
          Image.asset('imagess/p5.png'),
          Image.asset('imagess/55.jpg'),
          Image.asset('imagess/images.jpeg'),
          Image.asset('imagess/mm.gif'),
          Image.asset('imagess/mm2.gif'),
          Image.asset('imagess/mm3.gif'),
        ],
      ),
    );
  }
